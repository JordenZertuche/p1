...
public class user
{
    ...
    public user(String username, String email, String address, String favoriteAnimal, String favoriteColor, String favoriteNumber) {
    ...
    //instantiate two different objects with the informaion provided by the user

    public String instantiate() {
        String instantiate = "";
        instantiate = username.substring(0, 2) + email.substring(0, 2) + address.substring(0, 2) + favoriteAnimal.substring(0, 2) + favoriteColor.substring(0, 2) + favoriteNumber.substring(0, 2);
        return instantiate;
    }

    //generate two passwords from two user objects

    public String generate() {
        String generate = "";
        generate = username.substring(0, 2) + email.substring(0, 2) + address.substring(0, 2) + favoriteAnimal.substring(0, 2) + favoriteColor.substring(0, 2) + favoriteNumber.substring(0, 2);
        return generate;
    }

    //create a method display the password, the encrypted version of the password (with the secret key), and the results of the decrypt operation

    public String displayPassword() {
        String displayPassword = "";
        displayPassword = username.substring(0, 2) + email.substring(0, 2) + address.substring(0, 2) + favoriteAnimal.substring(0, 2) + favoriteColor.substring(0, 2) + favoriteNumber.substring(0, 2);
